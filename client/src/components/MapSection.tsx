...
import { Map, MapPin, Car, Route } from 'lucide-react';
import { Card, CardContent } from "@/components/ui/card";
import RideMap from '../../client2/src/components/RideMap';
    ...
    <section id="map" className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <Card className="max-w-6xl mx-auto overflow-hidden border-none shadow-2xl">
          <CardContent className="p-0">
            <div className="relative">
              {/* Replace dummy map with RideMap */}
              <div className="aspect-[16/9] relative overflow-hidden">
                <RideMap pickup={pickup} dropoff={dropoff} />
                
                {/* Bengaluru Coordinates */}
                <div className="absolute top-4 left-4 bg-white/80 py-1 px-3 rounded-full text-sm font-medium shadow-md pointer-events-none">
                  Bengaluru | 12.9716° N, 77.5946° E
                </div>
